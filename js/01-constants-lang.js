...
const LANG = {
  vi: {
    ...
    rateLimitPost:'Chỉ có thể đăng bài mỗi 30 giây. Vui lòng thử lại sau {n} giây',
    rateLimitComment:'Chỉ có thể bình luận mỗi 10 giây. Vui lòng thử lại sau {n} giây',
    reportBtn: 'Báo cáo',
    reportTitle: 'Báo cáo nội dung',
    reportDone: 'Đã tiếp nhận báo cáo. Chúng tôi sẽ xem xét và xử lý',
    reportAlready: 'Bạn đã báo cáo nội dung này',
    reportFail: 'Gửi báo cáo thất bại. Vui lòng thử lại',
    reportReasonSpam: 'Quảng cáo · Spam',
    reportReasonAbuse: 'Lời lẽ thô tục · Thù địch',
    reportReasonPrivacy: 'Tiết lộ thông tin cá nhân',
    reportReasonSexual: 'Nội dung khiêu gợi',
    reportReasonFraud: 'Lừa đảo · Môi giới bất hợp pháp',
    reportReasonOther: 'Khác',
    reportDetailPlaceholder: 'Mô tả thêm (tùy chọn)',
  ...
  ko: {
    ...
    rateLimitPost:'글은 30초에 한 번만 작성할 수 있어요. {n}초 후에 다시 시도해주세요',
    rateLimitComment:'댓글은 10초에 한 번만 작성할 수 있어요. {n}초 후에 다시 시도해주세요',
    reportBtn: '신고',
    reportTitle: '신고하기',
    reportDone: '신고가 접수되었습니다. 확인 후 조치하겠습니다',
    reportAlready: '이미 신고한 내용입니다',
    reportFail: '신고 접수에 실패했습니다. 다시 시도해주세요',
    reportReasonSpam: '광고 · 도배',
    reportReasonAbuse: '욕설 · 혐오 표현',
    reportReasonPrivacy: '개인정보 노출',
    reportReasonSexual: '음란물 · 선정성',
    reportReasonFraud: '사기 · 불법 알선',
    reportReasonOther: '기타',
    reportDetailPlaceholder: '추가 설명 (선택)',
    reportSubmit: '신고 접수',
    reportCancel: '취소',
  },
};
