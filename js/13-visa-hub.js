        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-3">
          ...
          <div className="grid grid-cols-2 gap-2 p-3">
            {[
              ...
              ...(selectedRoute === 'd9route' && selectedStep === 'f27_d8' ? [{ e:'📋', ko:'심사 조건',   vi:'Điều kiện thẩm định',      bg:'bg-teal-600',   act:()=>{ window.__visaState = {visaRoute:selectedRoute, visaSubRoute:selectedSubRoute, visaStep:selectedStep}; nav({page:'checklist', param:'f27_criteria', prevPage:'visaHub'}) } }] : []),
              ...
              ...(['f27_e71', 'f27_d8'].includes(selectedStep) ? [{ e:'👥', ko:'점수 방법',   vi:'Bảng tính điểm',      bg:'bg-blue-600',   act:()=>{ window.__visaState = {visaRoute:selectedRoute, visaSubRoute:selectedSubRoute, visaStep:selectedStep}; nav({page:'eligibility', param:'f27_e71', prevPage:'visaHub'}) } }, { e:'📋', ko:'심사 기준',   vi:'Điều kiện thẩm định',      bg:'bg-sky-600',   act:()=>{ window.__visaState = {visaRoute:selectedRoute, visaSubRoute:selectedSubRoute, visaStep:selectedStep}; nav({page:'assessment', param:'f27_e71', prevPage:'visaHub'}) } }] : []),
