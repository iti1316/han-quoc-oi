...
function WritePage({ initCat, editPost, nav, lang = 'vi', onAddPost, onUpdatePost, deviceId, route }) {
  ...
  const CAT_BOARD = { hall:'d9', sos:'d9', bamboo:'bamboo', talk:'bamboo', love:'love', travel:'travel', market:'market', house:'house', hospital:'hospital', horror:'horror', info:'info', jobs:'jobs' };
