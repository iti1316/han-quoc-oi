...
const VISA_GUIDE_DATA = {
  ...
  d9: {
    ...
    target:    { ko:'장기 무역 사업 운영 → F-2-7 또는 F-5 거주권 진행', vi:'D-9 để tiến lên visa F-2 (cư trú dài hạn) hoặc F-5 (thường trú)' },
    steps: [
    ...
    tip: { ko:'D-9 총 체류는 최대 2년. 장기 거주를 원한다면 F-2-7 또는 F-5로 진행해야 합니다!', vi:'D-9 tổng cộng tối đa 2 năm. Để tiếp tục sống tại Hàn, bạn cần chuyển sang F-2 hoặc F-5!' },
  },
  e71: {
  ...
  e74: {
    ...
    summary:   { ko:'E-9 제조업에서 4년 경험 후 200점 이상으로 신청 — 최초 2년 부여, 연장 반복 후 F-2-99 진입', vi:'Là loại visa được thiết kế riêng cho các bạn đang làm việc tại Hàn Quốc dưới dạng lao động phổ thông (như Visa E-9, E-10, H-2) muốn nâng cấp lên diện chuyên gia để có thể ở lại Hàn Quốc lâu dài và bảo lãnh được vợ/chồng, con cái sang sinh sống cùng' },
  ...
  f27_e71: {
    ...
    name:      { ko:'점수제 거주비자 (제조업 베테랑)',                  vi:'Visa cư trú diện tích điểm' },
    summary:   { ko:'E-7-4 숙련기능에서 3년 체류 후 신청 (또는 4,000만원 고소득 시 즉시 가능) — 제조업 베테랑의 영주권 진입로', vi:'- Tự do nhảy việc/Làm chủ: Bạn có thể làm việc ở bất kỳ công ty nào, bất kỳ ngành nghề nào (trừ một số ngành hạn chế phổ thông) hoặc tự mở doanh nghiệp/hộ kinh doanh cá thể mà không cần công ty bảo lãnh.\n-Bảo lãnh và quyền làm việc của gia đình: Vợ/chồng (F-3) được đi làm hợp pháp (chuyển sang diện F-2-71) nếu thu nhập của bạn đạt chuẩn GNI.' },
    maxStay:   { ko:'1~3년 단위 갱신 (GNI 1배 이상 소득 계속 유지 필수)', vi:'Thời hạn lưu trú dài: Lên tới 3 - 5 năm cho một lần cấp (tùy thuộc vào tổng số điểm bạn đạt được), gia hạn dễ dàng nếu duy trì đủ điểm.' },
    target:    { ko:'3년 이상 F-2-7 유지 후 F-5 영주권 신청 가능 — 제조업 근로자의 최종 목표', vi:'Đường thẳng lên Thường trú (F-5): Chỉ cần giữ F-2-7 từ 1 năm trở lên (kèm đủ điều kiện thu nhập) là có thể nộp đơn xin visa vĩnh viễn F-5.' },
    steps: [
    ...
    tip: { ko:'🚨 [제조업 베테랑의 F-2-7 합격 3대 법칙] ① 신청 전 \'본인 소득\'을 국세청 소득금액증명원으로 직접 확인하기 (계약서와 실제 신고 소득이 다를 수 있음!) ② 한국어 KIIP 5단계 또는 TOPIK 5급 이상 반드시 확보 (4급 이하는 점수 부족 위험) ③ 3년 체류 vs 고소득 즉시 신청 중 자신의 소득으로 어떤 경로인지 명확히 파악! 💡 가장 흔한 탈락 원인: 제조업 수당(잔업, 특근, 야간비)이 제대로 세금 신고되지 않아 실제 소득이 GNI 기준 미달로 떨어지는 경우. 매년 연장 시마다 이 기준을 계속 유지해야 하므로 소득 관리가 절대 중요! ⭐ F-2-7 취득 후의 이직 자유와 비수도권 가산점 혜택을 최대한 활용하면, 영주권(F-5)까지 순탄한 여정을 보장받을 수 있습니다!', vi:'Không tính lương trên hợp đồng: Điểm thu nhập của F-2-7 tính dựa trên con số thực tế bạn đã đóng thuế hiển thị trên tờ 소득금액증명원 của Cục Thuế, không tính mức lương ghi trên hợp đồng lao động mới ký.\nCảnh giác với điểm trừ (감점): Các lỗi vi phạm luật giao thông (bị phạt tiền), đi làm chui trước đó, hoặc vi phạm luật cư trú có thể bị trừ từ 5 đến 70 điểm, kéo tổng điểm của bạn xuống dưới mức 80 điểm và gây trượt visa ngay lập tức.\nMẹo tăng điểm nhanh: Nếu thiếu vài điểm để chạm mốc 80, bạn nên tham gia các khóa tình nguyện được đăng ký trên cổng thông tin 1365 (được cộng tối đa 7 điểm) hoặc cố gắng hoàn thành lớp KIIP Lớp 5 (được cộng ngay 10 điểm).' },
    docs: {
      change: [
        { ko:'[ ] 통합신청서 + 증명사진 1장 (3.5 x 4.5)', vi:'[ ] Đơn tổng hợp + 1 Ảnh thẻ nền trắng (3.5 x 4.5).' },
        { ko:'[ ] 여권 & 외국인등록증(ARC) 원본', vi:'[ ] Hộ chiếu & Thẻ ARC gốc.' },
        { ko:'[ ] 점수표 (점수표): 출입국청 양식에 따라 작성', vi:'[ ] Bảng tự chấm điểm (점수표): Điền theo mẫu của Cục Xuất nhập cảnh.' },
        { ko:'[ ] 점수 증빙 서류:', vi:'[ ] Giấy tờ chứng minh điểm số đã khai:' },
        { ko:'학위증명서 + 성적표 (대학/대학원)', vi:'Bằng tốt nghiệp + Bảng điểm (Đại học/Thạc sĩ).' },
        { ko:'한국어 능력증명서 (TOPIK 또는 KIIP 수료증)', vi:'Chứng chỉ tiếng Hàn (TOPIK hoặc bằng chứng nhận lớp Hội nhập xã hội KIIP).' },
        { ko:'소득금액증명원: 국세청 발급, 최근 연도 (점수 결정의 가장 중요한 서류)', vi:'Giấy chứng nhận thu nhập (소득금액증명원): Do Cục Thuế cấp cho năm gần nhất (Yếu tố cực kỳ quan trọng quyết định số điểm lớn).' },
        { ko:'[ ] 현재 고용계약서', vi:'[ ] Hợp đồng lao động hiện tại.' },
        { ko:'[ ] 주택 임차계약서', vi:'[ ] Hợp đồng thuê nhà.' },
        { ko:'[ ] 법적 기록 (형사기록증명서 2호): 외교 인증 필수 (한국 거주 중 6개월 이상 출국하지 않은 경우 제외 가능)', vi:'[ ] Lịch sử tư pháp (Lý lịch tư pháp số 2): Hợp pháp hóa lãnh sự (được miễn nếu ở Hàn liên tục không cư trú nước ngoài quá 6 tháng).' },
        { ko:'[ ] 수수료: 130,000 KRW', vi:'[ ] Lệ phí: 130.000 KRW.' },
      ],
      extension: [
        { ko:'[ ] 통합신청서 (\'체류기간 연장\' 항목 체크)', vi:'[ ] Đơn tổng hợp (통합신청서): Tích chọn mục Gia hạn thời gian lưu trú (Extension of Stay).' },
        { ko:'[ ] 여권 & 외국인등록증(ARC) 원본', vi:'[ ] Hộ chiếu & Thẻ ARC gốc.' },
        { ko:'[ ] 점수표 (최신 기준으로 재계산)', vi:'[ ] Bảng tự chấm điểm (점수표): Điền theo mẫu cập nhật mới nhất.' },
        { ko:'[ ] 소득금액증명원 (최근 연도 - 가장 중요!)', vi:'[ ] Giấy chứng nhận thu nhập (소득금액증명원): Do Cục Thuế cấp cho năm gần nhất (Đây là giấy tờ quan trọng nhất để chứng minh bạn vẫn duy trì đủ điểm thu nhập).' },
        { ko:'[ ] 현재 고용계약서 (계약 유효 기간 확인)', vi:'[ ] Hợp đồng lao động hiện tại (để chứng minh bạn vẫn đang có công việc hợp pháp).' },
        { ko:'[ ] 거주지 임차계약서', vi:'[ ] Hợp đồng thuê nhà (Chứng minh nơi cư trú).' },
        { ko:'[ ] 연장 수수료: 60,000 KRW', vi:'[ ] Lệ phí gia hạn: 60.000 KRW.' },
      ]
    },
  },
  f299: {
    code:'F-2-99', icon:'🌟', color:'bg-purple-600',
  ...
  d2: {
    ...
    target:  { ko:'졸업 후 D-10(구직) → E-7-1 또는 F-2-7 전환', vi:'-Sau tốt nghiệp đại học -> d10 tìm viêc -> E7-1\n- Sau tốt nghiệp cao học --> d10 tìm việc --> F2-7' },
    steps: [
      { ko:'Bước 1 — Nhận giấy báo nhập học chuẩn (표준입학허가서)\nDo hiệu trưởng/trưởng khoa của trường tại Hàn Quốc cấp cho sinh viên đã trúng tuyển.', vi:'Bước 1 — Nhận giấy báo nhập học chuẩn (표준입학허가서)\nDo hiệu trưởng/trưởng khoa của trường tại Hàn Quốc cấp cho sinh viên đã trúng tuyển.' },
      { ko:'Bước 2 — Chuẩn bị hồ sơ nộp tại Lãnh sự quán/Đại sứ quán Hàn Quốc\nHồ sơ cơ bản gồm: đơn xin cấp visa (có dán ảnh), hộ chiếu, lệ phí, bản sao giấy báo nhập học chuẩn. Ngoài ra tùy đối tượng còn cần: giấy chứng nhận đăng ký kinh doanh của cơ sở giáo dục, chứng minh năng lực tài chính (như sổ tiết kiệm chứng minh số dư của bố mẹ, kèm giấy tờ chứng minh quan hệ gia đình nếu dùng sổ tiết kiệm của bố mẹ).\nLưu ý: nếu trường mời thuộc diện trường bị hạn chế cấp visa, hoặc trường thuộc diện "tư vấn" (컨설팅대학), hồ sơ sẽ bị thẩm tra nghiêm ngặt hơn theo hướng dẫn chung dành cho du học sinh. Nếu trường thuộc diện "trường được chứng nhận" (인증대학) thì chỉ cần giấy báo nhập học chuẩn là đủ để xét duyệt.', vi:'Bước 2 — Chuẩn bị hồ sơ nộp tại Lãnh sự quán/Đại sứ quán Hàn Quốc\nHồ sơ cơ bản gồm: đơn xin cấp visa (có dán ảnh), hộ chiếu, lệ phí, bản sao giấy báo nhập học chuẩn. Ngoài ra tùy đối tượng còn cần: giấy chứng nhận đăng ký kinh doanh của cơ sở giáo dục, chứng minh năng lực tài chính (như sổ tiết kiệm chứng minh số dư của bố mẹ, kèm giấy tờ chứng minh quan hệ gia đình nếu dùng sổ tiết kiệm của bố mẹ).\nLưu ý: nếu trường mời thuộc diện trường bị hạn chế cấp visa, hoặc trường thuộc diện "tư vấn" (컨설팅대학), hồ sơ sẽ bị thẩm tra nghiêm ngặt hơn theo hướng dẫn chung dành cho du học sinh. Nếu trường thuộc diện "trường được chứng nhận" (인증대학) thì chỉ cần giấy báo nhập học chuẩn là đủ để xét duyệt.' },
      { ko:'Bước 3 — Thời gian xử lý\nVisa du học thường mất khoảng 20 ngày làm việc kể từ ngày nộp hồ sơ, nhưng có thể kéo dài hơn dự kiến do quá trình thẩm tra học vấn và xác minh thực tế → nên nộp sớm, có dư thời gian.', vi:'Bước 3 — Thời gian xử lý\nVisa du học thường mất khoảng 20 ngày làm việc kể từ ngày nộp hồ sơ, nhưng có thể kéo dài hơn dự kiến do quá trình thẩm tra học vấn và xác minh thực tế → nên nộp sớm, có dư thời gian.' },
      { ko:'Bước 4 — Nhập cảnh và đăng ký sau khi đến Hàn Quốc\nĐăng ký thẻ ngoại kiều (외국인등록증/ARC) trong vòng 90 ngày kể từ ngày nhập cảnh.\nNếu muốn ở lại quá 90 ngày hoặc cần đổi/gia hạn tư cách lưu trú, nộp hồ sơ tại Cục xuất nhập cảnh (출입국·외국인청).', vi:'Bước 4 — Nhập cảnh và đăng ký sau khi đến Hàn Quốc\nĐăng ký thẻ ngoại kiều (외국인등록증/ARC) trong vòng 90 ngày kể từ ngày nhập cảnh.\nNếu muốn ở lại quá 90 ngày hoặc cần đổi/gia hạn tư cách lưu trú, nộp hồ sơ tại Cục xuất nhập cảnh (출입국·외국인청).' },
    ],
...
const VISA_ROUTES = [
  ...
  },
  {
    ...
    color: 'bg-blue-700',
    desc: { ko: 'E-9, E-7-4, F-2-99, F-5', vi: 'E-9, E-7-4, F-2-99, F-5' },
    steps: [
      { code:'E-9',   key:'e9'  },
      { code:'E-7-4', key:'e74' },
      { code:'F-2-99', key:'f299' },
      { code:'F-5',   key:'f5_veteran'  },
    ]
  },
  {
  ...
  },
  {
    ...
    color: 'bg-indigo-700',
    desc: { ko: 'D-9, F-2-7, F-5', vi: 'D-9, F-2-7, F-5' },
    steps: [
      { code:'D-9',   key:'d9'  },
      { code:'F-2-7', key:'f27_d8' },
      { code:'F-5',   key:'f5_veteran'  },
