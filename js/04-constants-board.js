const CLASSIC_BOARD_CFG = {
  ...
  love:   { ko:'💕 썸, 연애, 부부',        vi:'Chuyện đôi lứa',         desc_ko:'썸, 연애, 결혼 생활 이야기를 익명으로 나누는 공간입니다.', desc_vi:'Chia sẻ chuyện hẹn hò, tình yêu và hôn nhân một cách ẩn danh.',            cats:['love'],   writeParam:'love' },
...
const LOCKED_CATS = ['travel', 'market', 'house', 'hospital', 'horror', 'bamboo', 'love', 'talk', 'info', 'jobs'];
const LOCKED_CAT_INFO = {
  ...
  love:   { e:'💕', ko:'썸, 연애, 부부',     vi:'Chuyện đôi lứa',     desc_ko:'연애·결혼 이야기를 익명으로', desc_vi:'Chia sẻ chuyện tình yêu, ẩn danh hoàn toàn' },
...
const BOARD_HOT_CFG = [
  ...
  { key:'love',   cats:['love'],                emoji:'💕', bg:'bg-rose-600',   ko:'썸, 연애, 부부', vi:'Chuyện đôi lứa' },
...
const CAT_BOARD_MAP = {
  ...
  love:   { key:'love',   emoji:'💕', bg:'bg-rose-600',   ko:'썸, 연애, 부부', vi:'Chuyện đôi lứa' },
...
const SEARCH_BOARD_INFO = {
  ...
  love:   { key:'love',   emoji:'💕', ko:'썸, 연애, 부부', vi:'Chuyện đôi lứa', bg:'bg-rose-600' },
